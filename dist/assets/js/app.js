...
global.app = function () {
	...
	var scroll_time = new Date().getTime() - page_cooldown; // last scroll timestamp
  ...
  */
	var onCooldown = function onCooldown(cooldown) {
  ...
  */
	var scrollPage = function scrollPage(new_id) {
