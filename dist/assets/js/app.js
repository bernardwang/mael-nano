...
global.app = function () {
	...
	var scroll_cooldown = 1000; // 1 second cooldown between page scrolls
	var scroll_time = new Date().getTime() + scroll_cooldown; // last scroll timestamp
