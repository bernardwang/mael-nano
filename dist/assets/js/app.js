...
global.app = function () {
	...
	var page_id = 0; // current page index
	var page = [// array of page
	'#maelstrom', '#overview', '#about', '#projects', '#people', '#apply'];

	var people_id = 0;
	var people_cycle = null;
	var people_bg = ['assets/img/empathetic.png', 'assets/img/genuine.png', 'assets/img/open.png', 'assets/img/curious.png', 'assets/img/bold.png'];

	var scroll_cooldown = 1000; // 1 second cooldown for mousescroll
	var scroll_threshold = 30; // ignore smaller scroll events
	var page_cooldown = 700; // .7 second cooldown for default page
	var page_last_ts = new Date().getTime() - page_cooldown; // last scroll timestamp

	/**
  * CSS preload #people cycle images
  */
	var preloadPeopleBgs = function preloadPeopleBgs() {
		var background = "";
		for (var i = 0; i < people_bg.length; i++) {
  ...
  */
	var stopPeopleCycle = function stopPeopleCycle() {
  ...
  */
	var startPeopleCycle = function startPeopleCycle() {
  ...
  */
	var isPageCooldown = function isPageCooldown(cooldown_ts) {
  ...
  */
	var goToPage = function goToPage(new_id) {
		...
		var new_page = page[new_id];
		var old_page = page[page_id];
		var new_nav = $('#nav').children()[new_id];
		var old_nav = $('#nav').children()[page_id];
		...
		setTimeout(function () {
			// After new page completely faded in, reset old page classes
  ...
  */
	$('.nav-link').click(function (e) {
		...
		e.preventDefault();
		var new_id = $('.nav-link').index($(this));
		goToPage(new_id);
	});
